...
if (!isset($_COOKIE['email'])) {
    ...
    if (isset($_GET['button'])) {
        ...
        if ($op == "Pay") {
            ...
            $api_key = 'bb120400-2217-45b0-830b-3d88db8a1136';
            $collection_id = '3reqn8nf';
            ...
            $data = array(
                ...
                'callback_url' => "http://localhost/GETAHSERDANG/index.php",
                'redirect_url' => "http://localhost/GETAHSERDANG/mobile/payment_update.php?userid=$email&mobile=$mobile&amount=$amount"
            );
    ...
    $sqlloadcart = "SELECT * FROM tbl_carts INNER JOIN tbl_product ON tbl_carts.prid = tbl_product.prid WHERE tbl_carts.email = '$email'";
...
<head>
    <title>Kedai Getah Serdang</title>
...
<body>
    <div class="header">
        <a href="#default" class="logo">Kedai Getah Serdang</a>
